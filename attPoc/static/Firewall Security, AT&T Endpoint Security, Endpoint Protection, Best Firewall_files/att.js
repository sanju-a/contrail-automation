 ...
 *
 * $Id: att.js 10410 2008-09-15 18:52:53Z dthunig $
 *
 * Behavior Library
 */
...
/* Business Unit Sidebar Placeholder */

  //Commented out for merger image

  //var sidebar = getElementsByClass('sidebar', 'DIV');
  //if (!isdef(sidebar[0])) { return true; }
  //var sidebar_content = getElementsByClass('content', 'DIV', sidebar[0]);
  //if (!isdef(sidebar_content[0])) { return true; }
  //var buph = "\n&nbsp;\n";
  //var bph = document.createElement('div'); addClass(bph, 'bu-placeholder');
  //bph.innerHTML = buph; insertBefore(bph, sidebar_content[0].firstChild); 
